...
export type PlasmicMachinesCategoriesPage__VariantMembers = {};
export type PlasmicMachinesCategoriesPage__VariantsArgs = {};
type VariantPropType = keyof PlasmicMachinesCategoriesPage__VariantsArgs;
export const PlasmicMachinesCategoriesPage__VariantProps =
  new Array<VariantPropType>();

export type PlasmicMachinesCategoriesPage__ArgsType = {};
type ArgPropType = keyof PlasmicMachinesCategoriesPage__ArgsType;
export const PlasmicMachinesCategoriesPage__ArgProps = new Array<ArgPropType>();

export type PlasmicMachinesCategoriesPage__OverridesType = {
  machinesCategories?: Flex__<"div">;
...
export interface DefaultMachinesCategoriesPageProps {}
...
function PlasmicMachinesCategoriesPage__RenderFunc(props: {
  variants: PlasmicMachinesCategoriesPage__VariantsArgs;
  args: PlasmicMachinesCategoriesPage__ArgsType;
  overrides: PlasmicMachinesCategoriesPage__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">
          {PlasmicMachinesCategoriesPage.pageMetadata.title}
        </title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicMachinesCategoriesPage.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicMachinesCategoriesPage__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicMachinesCategoriesPage__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicMachinesCategoriesPage__ArgsType,
      ReservedPropsType
    > &
