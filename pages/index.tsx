    ...
    <div style={{ width: "100%", padding: "100px", alignContent: "center" }}>
      <header>
        ...
        <h4>
          ...
          <h3>Your pages:</h3>
          <ul>
            <li><Link href="/Dashboard">DashboardPage - /Dashboard</Link></li>
<li><Link href="/machine-types">MachineTypesPage - /machine-types</Link></li>
<li><Link href="/machines-categories">MachinesCategoriesPage - /machines-categories</Link></li>
<li><Link href="/login-page">LoginPage - /login-page</Link></li>
<li><Link href="/login-error-page">LoginErrorPage - /login-error-page</Link></li>
          </ul>
